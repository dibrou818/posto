...
// the app's own pins (added separately, after this runs — see the "load"
// handler below), so the base map's job is just legible geography under
...
function applyCleanTheme(map: maplibregl.Map) {
